...
\author[2]{Holmes$^*$, Connor}
\author[2]{Lilge$^*$, Sven}
\author[2]{Guo, Zi Cong}
\author[3]{Dellaert, Frank}
\author[1]{Barfoot, Timothy D.}

\affil[1]{University of Toronto; {connor.holmes, }@mail.utoronto.ca, {sven.lilge, tim.barfoot}@utoronto.ca}
\affil[2]{University of Toronto\\{\small $^*$ denotes equal contribution}; {connor.holmes, }@mail.utoronto.ca, {sven.lilge, tim.barfoot}@utoronto.ca}
\affil[3]{Georgia Institute of Technology; frank.dellaert@cc.gatech.edu}
...
\appendix
\input{factor_graph_bg}
\input{query_during_solve}
\input{api/api_overview}
