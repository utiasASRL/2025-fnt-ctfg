...
\begin{figure}[p]
     ...
     \caption{Generalized velocities associated with Figure~\ref{fig:se3_trajectory_example}.  The velocity is estimated at each measurement time and shown as blue dots including covariance. The interpolated velocities and covariances are shown as the solid line.  The green line is the ground truth velocity.}
