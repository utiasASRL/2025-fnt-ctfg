...
Under construction:
\begin{itemize}
\item give the general ideas of factoring the posterior then negative-log likelihood cost, then the optimization problem
\item discuss elimination in general
\item discuss fusion in general 
\end{itemize}
