...
\subsection{The Elimination Algorithm}\label{sec:elim-algo}
...
\begin{figure}[t]
     ...
     \centering
     \caption{Example of the elimination algorithm.  The left shows the factor graph before elimination, the middle shows the product factor formed by multiplying all factors involving $\mbf{x}$, and the right shows the result of eliminating $\mbf{x}$ from the factor graph, resulting in a new factor on the separator variables and a conditional density for $\mbf{x}$.}
     \label{fig:elim}
\end{figure}
...
\subsection{Gaussian Factors, Elimination, Fusion}
\label{sec:fgelimfus}
...
\subsection{Linear Discrete-Time Estimation}
\label{sec:ldte}
